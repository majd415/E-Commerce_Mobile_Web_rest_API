...
//url تسمى ايند بوينت اي هي يلي ينهي فيا ال url
...
DioHelper.postData(
    ...
    data: {
      ...
      'password':password,
        ...
        //loginModel انا هيك عبيتو
        loginModel= ShopLoadingModel.fromJson(value.data);
        // print(loginModel?.status);
        // print(loginModel?.message);
        // print(loginModel?.data?.token);

      emit(ShopLoginSuccessState(loginModel!));//ابعت معا ال login model
